...
public class OauthController {
    ...
    public Map<String,Object> token(HttpServletRequest request){
        HttpSession session = request.getSession();
        User userSeesion = (User) session.getAttribute(Constants.SESSION_USER);
...
//        String code = request.getParameter("code");
        ...
        //生成Authorization Code
        String code = authorizationService.createAuthorizationCode(clientIdStr, scopeStr, userSeesion);
